...
- Usando $_SERVER["HTTP_AUTHORIZATION"] para o App autenticar no appos na rede local. [@juliolobo](https://github.com/juliolobo)
...
### Added
- Auto Instalador app-os Ubuntu/Debian. [@barretowiisk](https://github.com/barretowiisk)
...
- Corrigido case "Negociação" onde faltava a cor e o break no codigo em os.php e appos.php. [@willph](https://github.com/willph)
...
## Added
- Adicionando relatório de clientes em xls. [@ataides](https://github.com/ataides)

## [4.10.0] - 2020-07-01

## Added
- Adicionando suporte a HMVC. [@ataides](https://github.com/ataides)

## Fixed
- Corrigindo erro na listagem quando arquivo não encontrado. [@ataides](https://github.com/ataides)
...
## Changed
- Melhoria em mensagem de erro pasta faltante system. [@ataides](https://github.com/ataides)
...
### Fixed
- Corrigido email de cliente no lugar de vendedor. [@ataides](https://github.com/ataides)
- Corrigido problema na tela de listagem de OS com garantia não numérica. [@ataides](https://github.com/ataides)

## [4.1.0] - 2020-03-04

### Fixed
- Corrigido layout e links de anexos de OS. [@ataides](https://github.com/ataides)
- Corrigido problema no layout de etiquetas. [@ataides](https://github.com/ataides)
- Corrigido layout e problema ao salvar pagamento. [@ataides](https://github.com/ataides)

## Changed
- Anexos de OS estruturados dentro de pastas MM-AAAA/OS-#ID. [@ataides](https://github.com/ataides)
...
### Added
- Adicionado opções de configuração do sistema. [@ataides](https://github.com/ataides)
...
### Fixed
- Corrigido arquivo de configurações. [@ataides](https://github.com/ataides)
...
### Changed
- Atualização da versão do Codeigniter para 3.1.11. [@ataides](https://github.com/ataides)
- Refatoramento de controllers para diminuir repetição de código. [@ataides](https://github.com/ataides)
- Simplificado exibição de mensagem de acesso expirado. [@ataides](https://github.com/ataides)
- Remoção de data e hora no menu superior. [@ataides](https://github.com/ataides)
...
### Changed
- Refatoramento de listagens de cadastros. [@ataides](https://github.com/ataides)
...
- Corrigido problema de return-path ao utilizar SMTP. [@ataides](https://github.com/ataides)
- Corrigido erro no link de WhatsApp ao não ter cadastro de emitente. [@ataides](https://github.com/ataides)
...
### Added
- Adicionado anotações na OS. [@ataides](https://github.com/ataides)
...
- Corrigido arquivo de update de data de expiração com data futura. [@ataides](https://github.com/ataides)

## [3.8.0] - 2019-07-25

### Added
- Adicionada pesquisa por múltiplos status em OS. [@ataides](https://github.com/ataides)
- Ao adicionar OS e Vendas usuário logado preenchido por padrão como responsável. [@ataides](https://github.com/ataides)
...
### Added
- Adicionada funcionalidade de envio de OS por email. [@ataides](https://github.com/ataides)

## [3.6.0] - 2019-06-29

### Added
- Adicionada verificação de permissão para exibição de estatísticas no painel. [@ataides](https://github.com/ataides)
- Adicionada possibilidade de alteração de preços de produtos e serviços em OS. [@ataides](https://github.com/ataides)
- Adicionada possibilidade de adicionar quantidade de serviços em OS. [@ataides](https://github.com/ataides)
- Adicionada possibilidade de alterar preços de produtos em Vendas. [@ataides](https://github.com/ataides)

### Changed
- Modificados alguns elementos de estilização. [@ataides](https://github.com/ataides)

## [3.5.3] - 2019-05-18

### Fixed
- Corrigido remoção de garantias ao editar OS. [@ataides](https://github.com/ataides) e [@willph](https://github.com/willph)
...
### Fixed
- Corrigido pesquisa de termos de garantia. [@ataides](https://github.com/ataides).
- Corrigido erro no cadastro de garantias ao buscar nome do usuário logado. [@ataides](https://github.com/ataides).
...
### Fixed
- Removendo obrigatoriedade do campo de garantias na tabela de OS para evitar erro ao não preencher no cadastro. [@ataides](https://github.com/ataides).

### Changed
- Alterado insert de usuário com permissão para o módulo de auditoria no arquivo sql. [@ataides](https://github.com/ataides)

## [3.5.0] - 2019-05-12

### Added
- Adicionado modulo de auditoria para monitoramento de atividades no sistema. [@ataides](https://github.com/ataides).
...
## [3.1.16] - 2019-01-14
### Added
- Adicionado e-mail do cliente na impressão da OS. [@ataides](https://github.com/ataides).

### Fixed
- Corrigido alteração de senha na tela minha conta [@ataides](https://github.com/ataides).
- Corrigido link no formulário de adicionar arquivo. [@ataides](https://github.com/ataides).

## [3.1.15] - 2018-11-24
### Fixed
- Corrigido campo descrição na impressão e visualização de OS [@ataides](https://github.com/ataides).

## [3.1.14] - 2018-11-13
### Added
- Modelo de impressão de OS otimizando espaços [@ataides](https://github.com/ataides).
...
- Arquivo de changelog [@ataides](https://github.com/ataides).


## [3.1.12] - 2018-08-14
### Added
- Valor total no relatório de OS [@ataides](https://github.com/ataides).
...
### Fixed
- Correção de erro ao gerar relatório sem emitente estar configurado [@ataides](https://github.com/ataides).
