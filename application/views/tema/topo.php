...
<head>
  <title>Software R.A.</title>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta name="csrf-token-name" content="<?= config_item("csrf_token_name") ?>">
  <meta name="csrf-cookie-name" content="<?= config_item("csrf_cookie_name") ?>">
  <link rel="shortcut icon" type="image/png" href="<?= base_url(); ?>assets/img/logora2.png" />
...
<body>
      ...
      <ul class="nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class=""><a title="Meu Perfil" href="<?= site_url('appos/minhaConta'); ?>"><span class="text">Meu Perfil</span></a></li>
            <li class="divider"></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?= site_url('appos/configurar') ?>">Sistema</a></li>
            <li><a href="<?= site_url('usuarios') ?>">Usuários</a></li>
            <li><a href="<?= site_url('appos/emitente') ?>">Emitente</a></li>
            <li><a href="<?= site_url('permissoes') ?>">Permissões</a></li>
            <li><a href="<?= site_url('auditoria') ?>">Auditoria</a></li>
            <li><a href="<?= site_url('appos/emails') ?>">Emails</a></li>
            <li><a href="<?= site_url('appos/backup') ?>">Backup</a></li>
          </ul>
        </li>
      </ul>
    </div>
      ...
      <section style="display:block;position:absolute;right:10px">
        <div class="profile">
          <div class="profile-img">
            <a href="<?= site_url('appos/minhaConta'); ?>"><img src="<?= !is_file(FCPATH . "assets/userImage/" . $this->session->userdata('url_image_user_admin')) ?  base_url() . "assets/img/User.png" : base_url() . "assets/userImage/" . $this->session->userdata('url_image_user_admin') ?>" alt=""></a>
          </div>
        </div>
      </section>
  ...
  <div style="display: none" id="search">
    <form action="<?= site_url('appos/pesquisar') ?>">
