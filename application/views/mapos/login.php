...
<body>
  <div class="main-login">
    <div class="left-login">
      ...
      <img src="<?php echo base_url() ?>assets/img/dashboard-animate.svg" class="left-login-image" alt="Software R.A. - Versão: <?= $this->config->item('app_version'); ?>">
    </div>
          ...
          <div class="container">
            <div class="card">
              <div class="content">
                <div id="newlog">
                  <div class="icon2">
                    <img src="<?php echo base_url() ?>assets/img/logora2.png">
                  </div>
                  <!--<div class="title01">
                    <?= '<img src="' . base_url() . 'assets/img/logo-appos-branco.png">'; ?>
                  </div>-->
                </div>
                ...
                <div class="links-uteis"><a href="">
                    <p><?= date('Y'); ?> &copy; Ataídes Borges</p>
                  </a>
                </div>
                <a href="#notification" id="call-modal" role="button" class="btn" data-toggle="modal" style="display: none ">notification</a>
                <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-header">
                    <h4 id="myModalLabel">Software R.A.</h4>
                  </div>
        ...
        submitHandler: function(form) {
          ...
          $.ajax({
            ...
            success: function(data) {
                if (data.result == true) {
                    window.location.href = "<?= site_url('appos'); ?>";
                } else {
                    ...
                    var newCsrfToken = data.appos_TOKEN; 
