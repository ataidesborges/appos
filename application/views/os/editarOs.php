                            ...
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formProdutos" action="<?php echo base_url() ?>index.php/os/adicionarProduto" method="post">
                                    <div class="span6">
                                        ...
                                        <div class="addproduct"><?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aProduto')) { ?>
                                              <a href="<?php echo base_url(); ?>index.php/produtos/adicionar" class="btn btn-success"><i class="fas fa-plus"></i> Adicionar Produto</a><?php } ?></div>
                                    </div>
                                    <div class="span2">
                            ...
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formServicos" action="<?php echo base_url() ?>index.php/os/adicionarServico"
                                    ...
                                    <div class="span6">
                                        ...
                                        <div class="addservice"><?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aServico')) { ?>
                                              <a href="<?php echo base_url(); ?>index.php/servicos/adicionar" class="btn btn-success"><i class="fas fa-plus"></i> Adicionar Serviço</a><?php } ?></div>
