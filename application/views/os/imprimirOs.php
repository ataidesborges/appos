...
<head>
    <title>Software R.A. <?= $result->idOs ?> - <?= $result->nomeCliente ?></title>
            ...
            <header>
                <?php if ($emitente == null) : ?>
                    <div class="alert alert-danger" role="alert">
                        Você precisa configurar os dados do emitente. >>> <a href="<?=base_url()?>index.php/appos/emitente">Configurar</a>
                    </div>
                <?php else : ?>
