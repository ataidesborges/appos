...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/img/logora2.png">
...
<body>
    <div class="main-login">
        <div class="left-login">
            ...
            <img src="<?php echo base_url() ?>assets/img/forms-animate.svg" class="left-login-imagec" alt="app-os 5.0">
        </div>
                            ...
                            <div class="card card-cad">
                                <div class="content">
                                    <div id="newlog">
                                       ...
                                       <!-- <div class="title01">
                                            <img src="<?php echo base_url() ?>assets/img/logo-appos-branco.png">
                                        </div>-->
                                    </div>
