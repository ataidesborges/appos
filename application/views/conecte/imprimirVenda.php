                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <?php if ($emitente == null) { ?>
                                    ...
                                    <tr>
                                        <td colspan="3" class="alert">Você precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>index.php/appos/emitente">Configurar</a>
                                            <<<< /td>
                                    </tr> <?php } else { ?> <tr>
                                        ...
                                        <span>Responsável:<?php echo $result->nome ?></span> <br /></td>
                                        <td style="width: 18%; text-align: center">#Venda: <span><?php echo $result->idVendas ?></span></br> </br> 
