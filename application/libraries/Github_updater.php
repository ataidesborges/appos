...
class Github_updater
{
    ...
    public function update()
    {
        ...
        if ($hash !== $this->ci->config->item('current_commit')) {
            ...
            if ($dir = $this->_get_and_extract($hash)) {
                ...
                // Update the appos version in the config filename
    ...
    /**
     * Get appos current version.
     *
     * @return string appos current version.
     */
    private function getCurrentVersion()
    {
        ...
        if (! $version) {
            throw new Exception('Error getting appos version from GitHub!');
        }
