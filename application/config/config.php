 ...
 * Nome do sistema
 */
$config['app_name'] = $_ENV['APP_NAME'] ?? 'SOFTWARE R.A.';
...
|
*/
$config['base_url'] = 'http://apptaid/taid';
...
$config['csrf_token_name'] = $_ENV['APP_CSRF_TOKEN_NAME'] ?? 'appos_TOKEN';
$config['csrf_cookie_name'] = $_ENV['APP_CSRF_COOKIE_NAME'] ?? 'appos_COOKIE';
